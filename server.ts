...
async function startServer() {
  ...
  app.post("/api/send-lead", async (req, res) => {
    try {
      ...
      const emailContent = `
NEW LEAD CAPTURED FROM KROXX GADGETS AI ASSISTANT
...
${transcript}
      ...
      const response = await fetch("https://formsubmit.co/ajax/madudimcjx@gmail.com", {
        ...
        headers: { 
          ...
          'Origin': 'https://kroxxgadgets-ai.com',
          'Referer': 'https://kroxxgadgets-ai.com/'
        },
        body: JSON.stringify({
          _subject: `Urgent: Gadget Repair Lead - ${name}`,
          "Lead Name": name,
          "Phone Number": phone,
